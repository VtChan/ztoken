...
export type CloseInput<
  ...
  TAccountZtoken extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountZtoken>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountZtoken> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.ztoken),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountZtoken>;
